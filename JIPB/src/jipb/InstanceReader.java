...
import modele.AgenceLocale;
import modele.AgenceRegionale;
import modele.Client;

/**
 * Classe qui permet de lire une instance pour le projet de POO3 2021/2022.
...
public class InstanceReader {
    ...
    public void readInstance(EntityManager em) throws ReaderException {
        ...
        while(true) {
            ...
            ////////////////////////////////////////////
            cl = new Client((String) elem.getIdentifiant(), elem.getAbscisse(), elem.getOrdonnee(), nom ,(int) elem.getChiffreAffaires(), (int) elem.getEmprunts());
        ...
        while(true) {
            ...
            c = new AgenceLocale((String) elem.getIdentifiant(), elem.getAbscisse(), elem.getOrdonnee(), nom, (int) elem.getCoutLocation(), elem.getIdentifiant(),(int) elem.nbMaxClients,  elem.getAccessibilitte());
        ...
        while(true) {
            ...
            // elem.getAbscisse();
            // elem.getOrdonnee();
            // System.out.println(elem.getAbscisse());
            // elem.getCoutLocation()
            // elem.getChiffreAffairesMax()
            // elem.getEmpruntsMax()
            c = new AgenceRegionale((String) elem.getIdentifiant() , elem.getAbscisse(), elem.getOrdonnee(), nom, (int) elem.getCoutLocation(), elem.getIdentifiant(),(int) elem.getChiffreAffairesMax(), (int) elem.getEmpruntsMax());
            System.out.println(c);
            em.persist(c);
////////////////////////////////////////////
     ...
     * @param scanner lecteur du fichier
     * @param echappement tableau de chaines de caractere qui indique la fin de la lecture des clients
     * @return les informations sur le client, null s'il n'y a rien ou l'echapppement
     * @throws ReaderException lorsque le format attendu n'est pas respecte
     */
    ...
    /**
     * Lecture des informations sur une agence locale dans les six premieres colonnes :
     * l'identifiant sous forme de chaine de caractères, l'abscisse, l'ordonnee,
     * le cout de location sous forme de nombre reel, le nombre maximum de clients
     * sous forme de nombre entier, et le coefficient d'accessibilité sous forme 
     * de nomre reel.
     * @param scanner lecteur du fichier
    ...
    /**
     * Lecture des informations sur une agence regionale dans les six premieres colonnes :
     * l'identifiant sous forme de chaine de caractères, l'abscisse, l'ordonnee,
     * le cout de location, le chiffre d'affaires maximum et le montant d'emprunts
     * maximum sous forme de nombre reel.
     * @param scanner lecteur du fichier
     ...
     * les clients et les agences : identifiant, abscisse, ordonnee.
     */
    class Infos {
